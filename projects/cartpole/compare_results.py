...
def plot_comparison():
    ...
    plt.plot(moving_average(r_rewards), color='blue', linewidth=2, label='REINFORCE (Smoothed)')
    plt.plot(moving_average(d_rewards), color='orange', linewidth=2, label='DQN (Smoothed)')
    ...
    save_path = "projects/cartpole/results/comparison.png"
